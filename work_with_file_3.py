    ...
    for dish in dishes:
        ...
        for key in cook_book:
            if key==dish:
                ...
                print(dic_of_ing)
person_quantity=input('please, input quantity of person')
dishes_list=input('please, input names of dishes').split(',')

get_shop_list_by_dishes(dishes_list,person_quantity)
